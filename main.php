...
<?php include 'header.php'?>
		...
		<div id="home" class="hero-area">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url(./img/bg22.jpg); width:100%; height: 656px;"></div>
			<!-- /Backgound Image -->
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8">
							...
							margin-bottom:40px;">Confused What Career You Fit into the Most?<br><b>CareerQuest is the right Destination!</b></h1>
			...
			<div class="container">
				...
				<div class="row">
					<div class="section-header text-center">
						...
						<h2 style="margin-top: 100px; font-size: 45px;">Welcome to CareerQuest</h2>
						...
						<p class="lead"><b style="color: rgb(56, 48, 48);">CareerQuest</b> is one stop destination <br>in helping you understand yourself, the best career for you <br> and providing all the resources in the process.</p>
					</div>
				</div>	
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="section-header">
							<h2 style="font-size: 35px;">About CareerQuest</h2>
